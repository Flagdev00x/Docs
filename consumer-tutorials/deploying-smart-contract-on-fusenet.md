---
description: Steps on deploying a smart contract on Flagnet through Remix.
---

# Deploying smart contract on Flagnet
...
Since we interact with remix using Metamask, you need to change the network to Flag network by adding a custom RPC. Please follow the steps in [this tutorial](../how-to-add-fuse-to-your-metamask.md) to do that.

You need to have a small balance of FLAG on the Flagnet wallet you are using which will be used as Gas for the transactions.
