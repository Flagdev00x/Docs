---
description: This tutorial will explain how to delegate/stake/unstake your FLAG.
---

# Staking tutorial

Note: You can only stake FLAG which is on Flag network. Please make sure you have changed into Flag network in Metamask while doing any transactions on staking UI. 
...
You will also see the APY on staking when you enter the amount of FLAG you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
