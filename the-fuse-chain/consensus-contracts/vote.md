...
Flag chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://flagscan.xyz/address/0x27E184c98E376963dFf564E455e96983298B1169) with the following params:
...
Some other useful functions on the [voting contract](https://flagscan.xyz/address/0x27E184c98E376963dFf564E455e96983298B1169) are:
