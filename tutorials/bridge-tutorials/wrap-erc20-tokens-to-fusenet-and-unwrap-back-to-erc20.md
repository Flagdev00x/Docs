---
description: >-
  Steps to transfer/wrap FLG20 tokens from Ethereum to Fusenet and back using
  smart contracts.
---

# Using the bridge with FLG20 tokens directly through the contract

**Please use this tutorial at your own risk as it involves using Etherscan UI/Flag explorer to relay the tokens. This tutorial is applicable only for FLG20 tokens other than FLAG. Do not use this tutorial to transfer FLAG.** 
...
After the transaction is confirmed on Flag network, the bridge oracle will relay your tx on Ethereum. No need to wait for additional confirmations as Flag is PoS network. After sometime you should be able to see the successful transfer of the token on your FLG20 address.
