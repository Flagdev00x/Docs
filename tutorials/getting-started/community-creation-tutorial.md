...
Make sure you are connected to the Flag network on your Metamask wallet before creating the community. Learn how to add Flag network to Metamask using [this](../../how-to-add-fuse-to-your-metamask.md) tutorial.
...
It's been a long road, but you are finally on the last step! To be able to make easy mobile transactions using your community, **download the Flag wallet app** on the [App Store](https://apps.apple.com/il/app/flag-wallet/id1491783654) or [Google Play](https://play.google.com/store/apps/details?id=io.flag.fusecash).
