...
We will learn how to connect Ledger to Metamask and use it on Flag network after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change to “Flag network” and perform the transactions on Flag network through your Ledger device.

Note: To learn how to add Flag network RPC follow [this link.](https://docs.flagscan.xyz/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask)
