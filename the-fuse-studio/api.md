...
The token bridge connects the Ethereum and Flag network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Flag\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Flag network |
...
| homeBridgeAddress | `String` | Bridge address on the Flag network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Flag network |
...
Community is a set of contracts and services. Members of the community are users of the Flag network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Flag network |
| homeTokenAddress | `String` | Address of the community token on the Flag network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Flag network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Flag network |
...
Entity is an account on the Flag network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Flag network |
...
Tokens are compatible with the FLG20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
